...
description: "Record an architecture decision as a permanent ADR with rationale, alternatives, and impact"
category: Workflow
tags: [workflow, decision, adr]
---

Turn a made (or ready-to-adopt) decision into a permanent ADR record via the `tospec decision` command.

**Input**: The argument after `tospec-decision` describes the decision and, ideally, the reasoning and the alternatives considered.
